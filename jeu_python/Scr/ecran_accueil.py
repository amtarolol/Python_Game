...
class EcranAccueil:
    ...
    def run(self):
        image_accueil = pygame.image.load("ressources/sprites/acceuil/ecran_acceuil.jpg").convert_alpha()
        play_button = pygame.image.load("ressources/sprites/acceuil/play_buttom2.png").convert_alpha()
        son = pygame.mixer.Sound("ressources/sprites/acceuil/acceuil_sound.mp3")
        play_sound = pygame.mixer.Sound("ressources/sprites/acceuil/play_buttom.wav")
